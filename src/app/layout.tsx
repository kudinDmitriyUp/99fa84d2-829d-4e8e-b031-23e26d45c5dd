...
export const metadata: Metadata = {
  title: "Ristorante Eleganza - Premium Italian Dining in Los Angeles",
  description: "Experience authentic Italian cuisine at Ristorante Eleganza. Four generations of culinary tradition, handcrafted pasta, premium wines, and elegant dining in LA.",
  keywords: "Italian restaurant Los Angeles, authentic Italian cuisine, premium dining LA, handmade pasta, Italian wine, fine dining restaurant",
  ...
  openGraph: {
    title: "Ristorante Eleganza - Premium Italian Dining in Los Angeles",
    description: "Experience authentic Italian cuisine at Ristorante Eleganza. Four generations of culinary tradition in the heart of LA.",
    siteName: "Ristorante Eleganza",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763477521355-pkuo3pb2.jpg",
        alt: "Elegant Italian restaurant dining experience"
      }
    ]
  },
  twitter: {
    ...
    title: "Ristorante Eleganza - Premium Italian Dining in Los Angeles",
    description: "Experience authentic Italian cuisine at Ristorante Eleganza. Four generations of culinary tradition in the heart of LA.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763477521355-pkuo3pb2.jpg"]
  },
  robots: {
    index: true,
    follow: true
